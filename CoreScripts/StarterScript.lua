...
local GetFFlagLegacyRoactUpgradeFlag = require(CorePackages.Packages.GetFFlagLegacyRoactUpgradeFlag)
...
local FFlagEnableExperienceChat = require(RobloxGui.Modules.Flags.FFlagEnableExperienceChat)
...
if not GetFFlagLegacyRoactUpgradeFlag() then
